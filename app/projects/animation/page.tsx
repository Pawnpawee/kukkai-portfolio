...
import { animationProjectsData } from "@/data/constants";
import { motion } from "framer-motion";

export default function AnimationProjectsPage() {
  // Group projects by year
  const groupedProjects = animationProjectsData.reduce(
    (acc, project) => {
    ...
    {} as Record<string, typeof animationProjectsData>,
  );
